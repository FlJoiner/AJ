...
local ok, initErr = pcall(function()
    ...
    title.Text = "DARK HUB MAIN PANEL"
    ...
    titleShadow.Text = "DARK HUB MAIN PANEL"
...
-- removed discord button --
    ...
    otherCredits.Text = "Brought to you by johath11 on Discord"
 ...
 local function openDesyncGUI()
    ...
    minimizeBtn.MouseButton1Click:Connect(function()
        ...
        if minimized then
            ...
            title.Text = "[removed] MAIN PANEL"
            titleShadow.Text = "[removed] MAIN PANEL"
